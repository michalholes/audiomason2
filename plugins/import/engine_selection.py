"""Selection item helpers for Import Wizard Engine.

Kept in a separate module to avoid growth of the engine facade and to
keep selection-specific logic isolated.
