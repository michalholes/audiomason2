    ...
    *,
    ...
    gates_mod.run_gates(
        ...
        pytest_routing_policy={
            ...
            "pytest_smoke_targets": policy.pytest_smoke_targets,
            "pytest_area_prefixes": policy.pytest_area_prefixes,
            "pytest_area_names": policy.pytest_area_names,
            "pytest_area_targets": policy.pytest_area_targets,
            "pytest_family_areas": policy.pytest_family_areas,
            "pytest_family_targets": policy.pytest_family_targets,
            "pytest_broad_repo_prefixes": policy.pytest_broad_repo_prefixes,
            "pytest_broad_repo_targets": policy.pytest_broad_repo_targets,
        },
