...
class CoverHandlerSync:
    ...
    def find_cover_in_directory(self, directory: Path) -> Optional[Path]:
    ...
    def extract_cover_from_mp3(self, mp3_file: Path, output_path: Path) -> Optional[Path]:
    ...
    def download_cover(self, url: str, output_path: Path) -> Optional[Path]:
    ...
    def find_or_extract_cover(self, context: ProcessingContext) -> Optional[Path]:
