...
def test_plugin_loading():
    ...
    print()
    print(f"✅ Loaded {len(loader.list_plugins())} plugins: {loader.list_plugins()}")
    print()


def test_pipeline_yaml():
    """Test that pipeline YAML is valid."""
    print("🧪 Test 4: Pipeline YAML")
    print("-" * 50)
...
def main():
    ...
    try:
        ...
        print("=" * 70)
        print()
        print("🚀 MVP is ready for testing on Raspberry Pi!")
        print()
        print("Next steps:")
